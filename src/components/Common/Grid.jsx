        ...
        return (
            <div>
                {this
                    .state
                    .hideShowColumns
                    .map((column) => <li key={column.field}>
                        <div>
                            <Checkbox className="bis-grid-checkbox"
                                checked={column.hide}
                                onChange={(e) => this.onColumnHideCheckChange(column, e)}>{column.headerName}</Checkbox>
                        </div>
                    </li>)
                }
                ...
                <Button
                    ...
                    title="Save"
                    onClick={(e) => this.onColumnHideSaveClick(e)}>Save</Button>
            </div>
        )
    }
        ...
        for (let i = 0; i < this.state.hideShowColumns.length; i++) {
            ...
            for (let j = 0; j < this.props.columnDefs.length; j++) {
                ...
                if (hideShowColumn.headerName === column.headerName) {
                    ...
                    this
                        .grid_ColumnApi
                        .setColumnVisible(column.field, hideShowColumn.hide);
                }
            }
        }
            ...
            <Col span={23}>
                <div
                    ...
                    <AgGridReact
                        ...
                        rowData={this.props.rowData}></AgGridReact>
                </div>
            </Col>
